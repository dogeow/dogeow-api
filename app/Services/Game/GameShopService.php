...
class GameShopService
{
    ...
    public function __construct(
        private ?InventoryItemCalculator $itemCalculator = null,
        private ?ShopItemCreationService $itemCreationService = null
    ) {
        $this->itemCalculator ??= new InventoryItemCalculator;
        $this->itemCreationService ??= new ShopItemCreationService($this->itemCalculator);
    }
    ...
    {
        return $this->executeWithIdempotencyAndLock(
            ...
            lockTimeoutSeconds: self::SHOP_LOCK_TIMEOUT_SECONDS,
        );
    }
