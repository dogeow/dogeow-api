...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('game_skill_definitions', function (Blueprint $table) {
            $table->string('branch', 32)->nullable()->comment('技能分支/流派：fire火焰/ice冰霜/lightning闪电/warrior力量/ranger敏捷')->after('class_restriction');
            $table->unsignedTinyInteger('tier')->default(1)->comment('技能层级：1基础/2中级/3高级')->after('branch');
            $table->unsignedBigInteger('prerequisite_skill_id')->nullable()->comment('前置技能ID（学习此技能需要先学习前置技能）')->after('tier');
        });
        ...
        $skills = [
            // ====== 战士技能 ======
            // 力量分支 - 战士
            ['name' => '重击', 'description' => '基础物理攻击，造成100%武器伤害', 'type' => 'active', 'class_restriction' => 'warrior', 'branch' => 'warrior', 'tier' => 1, 'prerequisite_skill_id' => null, 'mana_cost' => 0, 'cooldown' => 0, 'skill_points_cost' => 1, 'base_damage' => 100, 'target_type' => 'single', 'icon' => 'sword'],
            ['name' => '冲锋', 'description' => '冲向敌人造成120%伤害', 'type' => 'active', 'class_restriction' => 'warrior', 'branch' => 'warrior', 'tier' => 2, 'prerequisite_skill_id' => 1, 'mana_cost' => 10, 'cooldown' => 3, 'skill_points_cost' => 1, 'base_damage' => 120, 'target_type' => 'single', 'icon' => 'zap'],
            ['name' => '旋风斩', 'description' => '旋转武器对所有敌人造成150%伤害', 'type' => 'active', 'class_restriction' => 'warrior', 'branch' => 'warrior', 'tier' => 3, 'prerequisite_skill_id' => 2, 'mana_cost' => 30, 'cooldown' => 8, 'skill_points_cost' => 2, 'base_damage' => 150, 'target_type' => 'all', 'icon' => 'wind'],

            // ====== 法师技能 ======
            // 火焰分支 - 法师
            ['name' => '火球术', 'description' => '发射火球造成100%魔法伤害', 'type' => 'active', 'class_restriction' => 'mage', 'branch' => 'fire', 'tier' => 1, 'prerequisite_skill_id' => null, 'mana_cost' => 5, 'cooldown' => 0, 'skill_points_cost' => 1, 'base_damage' => 100, 'target_type' => 'single', 'icon' => 'flame'],
            ...
            // 冰霜分支 - 法师
            ['name' => '冰箭', 'description' => '发射冰箭造成100%魔法伤害', 'type' => 'active', 'class_restriction' => 'mage', 'branch' => 'ice', 'tier' => 1, 'prerequisite_skill_id' => null, 'mana_cost' => 5, 'cooldown' => 0, 'skill_points_cost' => 1, 'base_damage' => 100, 'target_type' => 'single', 'icon' => 'snowflake'],
            ...
            // ====== 通用被动技能 ======
            ['name' => 'HP强化', 'description' => '提升最大生命值+50', 'type' => 'passive', 'class_restriction' => 'all', 'branch' => 'passive', 'tier' => 1, 'prerequisite_skill_id' => null, 'mana_cost' => 0, 'cooldown' => 0, 'skill_points_cost' => 1, 'base_damage' => 0, 'target_type' => 'single', 'icon' => 'heart'],
            ['name' => 'MP强化', 'description' => '提升最大法力值+30', 'type' => 'passive', 'class_restriction' => 'all', 'branch' => 'passive', 'tier' => 1, 'prerequisite_skill_id' => null, 'mana_cost' => 0, 'cooldown' => 0, 'skill_points_cost' => 1, 'base_damage' => 0, 'target_type' => 'single', 'icon' => 'zap'],
        ];
