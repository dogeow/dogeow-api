...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('note_links', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('source_id')->index()->comment('源笔记 ID');
            $table->unsignedBigInteger('target_id')->index()->comment('目标笔记 ID');
        ...
        if (DB::connection()->getDriverName() === 'mysql') {
            DB::statement("ALTER TABLE note_links COMMENT = '笔记双向链接表'");
        }
    }
